package services.semantria;


import services.semantria.mapping.output.*;
import services.semantria.mapping.output.stub.FeaturesList;
import services.semantria.utils.AuthRequest;
import services.semantria.utils.ObjProxy;
import services.semantria.interfaces.ICallbackHandler;
...
import services.semantria.mapping.configuration.*;
...
import services.semantria.serializer.JsonSerializer;
import services.semantria.serializer.XmlSerializer;
...
public final class Session 
{
	...
	public List<services.semantria.mapping.output.DocAnalyticData> getProcessedDocuments(String config_id)
	{
		String method = "GET";
		String url = serviceUrl + "/document/processed."+ requestFormat;
		List<services.semantria.mapping.output.DocAnalyticData> adata = new ArrayList<services.semantria.mapping.output.DocAnalyticData>();
		AuthRequest ar = new AuthRequest(url, method, key, secret, null, config_id, appName, useCompression);
		Integer status = ar.doRequest();
    ...
    public List<services.semantria.mapping.output.DocAnalyticData> getProcessedDocumentsByJobId(final String jobId)
    {
        String method = "GET";
        String url = serviceUrl + "/document/processed."+ requestFormat;
        List<services.semantria.mapping.output.DocAnalyticData> adata = new ArrayList<services.semantria.mapping.output.DocAnalyticData>();
	...
	public List<services.semantria.mapping.output.DocAnalyticData> getProcessedDocuments()
	{
		return getProcessedDocuments(null);
	}
	
	public List<services.semantria.mapping.output.CollAnalyticData> getProcessedCollections(String config_id)
	{
		String method = "GET";
		String url = serviceUrl + "/collection/processed."+ requestFormat;
		List<services.semantria.mapping.output.CollAnalyticData> adata = new ArrayList<services.semantria.mapping.output.CollAnalyticData>();
		AuthRequest ar = new AuthRequest(url, method, key, secret, null, config_id, appName, useCompression);
		Integer status = ar.doRequest();
    ...
    public List<services.semantria.mapping.output.CollAnalyticData> getProcessedCollectionsByJobId(final String jobId)
    {
        String method = "GET";
        String url = serviceUrl + "/collection/processed."+ requestFormat;
        List<services.semantria.mapping.output.CollAnalyticData> adata = new ArrayList<services.semantria.mapping.output.CollAnalyticData>();
	...
	public List<services.semantria.mapping.output.CollAnalyticData> getProcessedCollections()
	{
		return getProcessedCollections(null);
	}
	
	public services.semantria.mapping.output.DocAnalyticData getDocument(String id, String config_id)
	{
		String method = "GET";
		...
		Integer status = ar.doRequest();
		if (200 == status) {
			services.semantria.mapping.output.DocAnalyticData aData = (services.semantria.mapping.output.DocAnalyticData)serializer.deserialize(ar.getResponse(), services.semantria.mapping.output.DocAnalyticData.class);
			handleRequest(method, ar.getRequestUrl(), null);
			handleResponse(status, ar);
			return aData;
		} else {
	...
	public services.semantria.mapping.output.DocAnalyticData getDocument(String id)
	{
	...
	public CollAnalyticData getCollection(String id, String config_id)
	{
		...
		Integer status = ar.doRequest();
		if (200 == status) {
			services.semantria.mapping.output.CollAnalyticData cData = (services.semantria.mapping.output.CollAnalyticData)serializer.deserialize(ar.getResponse(), services.semantria.mapping.output.CollAnalyticData.class);
			handleRequest(method, ar.getRequestUrl(), null);
			handleResponse(status, ar);
			return cData;
		} else {
